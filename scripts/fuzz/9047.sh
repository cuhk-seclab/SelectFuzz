rm -rf 9047
git clone https://gitlab.gnome.org/GNOME/libxml2.git 9047
cd 9047; git checkout ef709ce2
...
echo $'valid.c:1279' > $TMP_DIR/real.txt
...
$AFLGO/afl-fuzz -m none -z exp -c 45m -i in -o out -d ./xmllint --valid @@
