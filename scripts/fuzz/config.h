...
#define LIBAV_CONFIGURATION "--disable-shared --prefix=/aflgo/scripts/fuzz/libav/obj-aflgo --cc=/aflgo/afl-clang-fast --extra-cflags='-targets=/aflgo/scripts/fuzz/libav/obj-aflgo/temp/BBtargets.txt -outdir=/aflgo/scripts/fuzz/libav/obj-aflgo/temp -flto -fuse-ld=gold -Wl,-plugin-opt=save-temps' --disable-doc --enable-cross-compile"
#define LIBAV_LICENSE "LGPL version 2.1 or later"
#define AVCONV_DATADIR "/aflgo/scripts/fuzz/libav/obj-aflgo/share/avconv"
#define CC_IDENT "clang version 4.0.0 (tags/RELEASE_400/final)"
