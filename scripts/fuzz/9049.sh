rm -rf 9049
git clone https://gitlab.gnome.org/GNOME/libxml2.git 9049
cd 9049; git checkout 45752d2
...
echo $'parser.c:3406' > $TMP_DIR/real.txt
...
$AFLGO/afl-fuzz -m none -z exp -c 45m -i in -o out -d ./xmllint --memory --oldxml10 @@
