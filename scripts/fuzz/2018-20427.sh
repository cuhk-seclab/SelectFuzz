git clone https://github.com/libming/libming.git libming-CVE-2018-20427
cd libming-CVE-2018-20427/; git checkout b72cc2f # version 0.4.8
rm -rf obj-aflgo
...
echo $'decompile.c:425' > $TMP_DIR/BBtargets.txt
echo $'decompile.c:425' > $TMP_DIR/real.txt
./autogen.sh;
...
echo ' ' >in/tmp.swf
$AFLGO/afl-fuzz -m none -z exp -c 45m -i in -o out -d ./util/swftopython @@
